...
int main(void) {
    ...
    HANDLE_ERROR( cudaMalloc(&data.output_bitmap, imageSize) );

    HANDLE_ERROR( cudaMalloc(&data.dev_inSrc, imageSize) );

    HANDLE_ERROR( cudaMalloc(&data.dev_outSrc, imageSize) );

    HANDLE_ERROR( cudaMalloc(&data.dev_constSrc, imageSize) );
